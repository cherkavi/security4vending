...
public class TaskDataInformationSet extends TaskData{
	 ...
	 */
	public TaskDataInformationSet(int timeWait, int timeError, int maxCount) {
		super(true, "Установить настройки для ThreadAlarm");

		Element alarm=this.getDocument().createElement("information");
