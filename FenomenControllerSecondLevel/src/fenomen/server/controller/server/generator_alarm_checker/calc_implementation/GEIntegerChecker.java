...
public class GEIntegerChecker extends AIntegerChecker<AlarmMessage>{
	 ...
	 */
	public GEIntegerChecker(int registerNumber, int delayMs, String message, int controlValue) {
