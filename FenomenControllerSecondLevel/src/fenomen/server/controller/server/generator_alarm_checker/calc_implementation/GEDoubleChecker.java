...
public class GEDoubleChecker extends ADoubleChecker<AlarmMessage>{
	 ...
	 */
	public GEDoubleChecker(int registerNumber, int delayMs, String message, double controlValue, int digit) {
