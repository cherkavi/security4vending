...
public class NEDoubleChecker extends ADoubleChecker<AlarmMessage>{
	 ...
	 */
	public NEDoubleChecker(int registerNumber, int delayMs, String message, double controlValue, int digit) {
