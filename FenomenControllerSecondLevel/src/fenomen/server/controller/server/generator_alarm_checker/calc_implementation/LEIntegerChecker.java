...
public class LEIntegerChecker extends AIntegerChecker<AlarmMessage>{
	 ...
	 */
	public LEIntegerChecker(int registerNumber, int delayMs, String message, int controlValue) {
