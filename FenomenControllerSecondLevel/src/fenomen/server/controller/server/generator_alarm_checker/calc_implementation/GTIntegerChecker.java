...
/** проверка на больше */
public class GTIntegerChecker extends AIntegerChecker<AlarmMessage>{
	 ...
	 */
	public GTIntegerChecker(int registerNumber, int delayMs, String message, int controlValue) {
