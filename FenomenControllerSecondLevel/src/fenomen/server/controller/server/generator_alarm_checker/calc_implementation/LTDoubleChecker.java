...
/** проверка на меньше */
public class LTDoubleChecker extends ADoubleChecker<AlarmMessage>{
	 ...
	 */
	public LTDoubleChecker(int registerNumber, int delayMs, String message, double controlValue, int digit) {
