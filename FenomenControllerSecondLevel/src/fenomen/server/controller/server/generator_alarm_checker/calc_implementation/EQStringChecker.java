...
public class EQStringChecker extends AStringChecker<AlarmMessage>{
	 ...
	 */
	public EQStringChecker(int registerNumber, int delayMiliseconds, String alarmDescription, String controlValue, boolean ignoreCase) {
