...
/** проверка на больше */
public class GTDoubleChecker extends ADoubleChecker<AlarmMessage>{
	 ...
	 */
	public GTDoubleChecker(int registerNumber, int delayMs, String message, double controlValue, int digit) {
