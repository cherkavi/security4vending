...
/** таблица TableRestart, которая отображает все данные от сервера  */
public class TableRestart extends JTable{
	private final static long serialVersionUID=1L;
	private TableRestartModel model;
	
	public TableRestart(){
		this.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
		this.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		this.setCellSelectionEnabled(true);
		this.model=new TableRestartModel();
	...
	public void setModelData(RestartSettingsElement[] list) {
		this.model.setData(list);
	}

	public RestartSettingsElement[] getModelData() {
...
class TableRestartModel extends AbstractTableModel{
	private final static long serialVersionUID=1L;
	private RestartSettingsElement[] data=null;
	@Override
	...
	public RestartSettingsElement[] getData() {
		return this.data;
	}

	/** установить данные для модели */
	public void setData(RestartSettingsElement[] data) {
		this.data=data;
