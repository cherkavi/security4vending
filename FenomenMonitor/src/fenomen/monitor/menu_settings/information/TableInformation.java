...
/** таблица TableInformation, которая отображает все данные от сервера  */
public class TableInformation extends JTable{
	private final static long serialVersionUID=1L;
	private TableInformationModel model;
	
	public TableInformation(){
		this.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
		this.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		this.setCellSelectionEnabled(true);
		this.model=new TableInformationModel();
	...
	public void setModelData(InformationSettingsElement[] list) {
		this.model.setData(list);
	}

	public InformationSettingsElement[] getModelData() {
...
class TableInformationModel extends AbstractTableModel{
	private final static long serialVersionUID=1L;
	private InformationSettingsElement[] data=null;
	@Override
	...
	public InformationSettingsElement[] getData() {
		return this.data;
	}

	/** установить данные для модели */
	public void setData(InformationSettingsElement[] data) {
		this.data=data;
